...
public class RepairBulletSpawnerAction : SteppedAction 
{
    public RepairBulletSpawnerAction
        (ActionType _action, Transform _transform, EnemyObject _resource, GameObject _target, ResourceType _resourceType, float _distanceToInteract, float _timeToGetResource, float _timeToInteract) 
